...
association_rules = apriori(market_data, min_support=0.2, min_confidence=0.2, min_lift=2, max_length=5)
...
association_rules = apriori(market_data, min_support=0.1, min_confidence=0.1, min_lift=2, max_length=5)
association_results = list(association_rules)
